...
var infoTestData = []testInfoText {
	testInfoText{
		`      <text xml:space="preserve">{{Infobox zoo
...
`,
	...
	testInfoText{
      ...
      <comment>Undid revision 769093011 by [[Special:Contributions/96.18.92.153|96.18.92.153]] ([[User talk:96.18.92.153|talk]])</comment>
      <model>wikitext</model>
      <format>text/x-wiki</format>
      <text xml:space="preserve">{{Infobox boxer
|name = Kid Chocolate
|nationality =   [[Cuba]]n
...
func testOneInfobox(t *testing.T, ti testInfoText) {
